...
\begin{enumerate}
  ...
  \item Sample $\tau^{2(s)}$ from $I-Gamma \left( \eta_0, \tau_0^2\right)$
...
This is because the posterior took information from the data which are very heterogeneous in this group, ranging from the low polluting poultry meat to the extremely polluting beef herd.
...
## Full conditional for $\boldsymbol{\theta_j, \sigma^2_j}$
